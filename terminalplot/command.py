...
optional arguments:
  ...
  -x X                 Values on x-axis. If empty, values on y-axis will be
                       plotted according to their indices, e.g. (0, y0),
                       (1, y1), ...
  -y Y                 Values on y-axis, at least one value has to be provided.
  -s, --terminal-size  Returns size of terminal <columns>, <rows>. No plot will
                       be generated.
...
from terminalplot import get_terminal_size, plot
...
def make_parser():
    parser = ArgumentParser(
        description="Minimalistic plot of a graph in terminal.",
    ...
    parser.add_argument(
        ...
        type=list_floats,
        help=(
            "Values on x-axis. If empty, values on y-axis will be plotted "
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "Returns size of terminal <columns>, <rows>. No plot will be"
            "generated."
        ),
    )
